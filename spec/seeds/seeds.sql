TRUNCATE TABLE users, spaces, bookings, dates, spaces_dates RESTART IDENTITY;
...
-- the following space is linked to these dates, further down in the join table: "2022-10-05", "2022-10-07", "2022-11-15"
('House', 'Lovely house at the seaside', 80, 2),
-- the following space is linked to these dates, further down in the join table: "2022-10-12", "2022-10-25"
('Flat', 'Flat in Central London', 125, 3),
